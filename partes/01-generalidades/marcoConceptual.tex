...
compartidos, tales como redes, servidores, almacenamiento y servicios. En este sentido, según~\cite{mell2011nist}, este modelo se 
...
Adicionalmente, este paradigma se fundamenta en cinco características principales autoservicio, amplio acceso a la red, agrupación 
de recursos, rápida elasticidad y servicio medido. Asimismo, contempla diferentes modelos de servicio, entre los cuales se encuentran infraestructura 
...
los activos de información en entornos de computación en la nube. La \textit{European Network and Information Security 
Agency}~\cite{enisa2009cloud}, establece que esta debe evaluarse considerando los riesgos asociados a la confidencialidad, integridad y 
...
de su valor, criticidad y nivel de riesgo, para poder garantizar su seguridad a lo largo de su ciclo de vida.
