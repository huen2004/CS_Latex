...
Con el objetivo de validar los aspectos de seguridad integrados mediante la arquitectura de defensa en profundidad implementada, se definió una 
...
Con el propósito de evaluar cuantitativa y cualitativamente el desempeño de la arquitectura de defensa en profundidad, se definieron criterios 
...
La herramienta de código abierto Hydra es utilizada para ejecutar ataques de fuerza bruta contra servicios de autenticación y es 
...
\subsection{Caso de Prueba 3 (CP-03) Escaneo de Vulnerabilidades web con Nikto}
\noindent
...
\subsection{Caso de Prueba 4 (CP-04) Ataque SSH con Metasploit}
\noindent
...
\subsection{Caso de Prueba 5 (CP-05) Denegación de Servicios (DoS) hping3}
\noindent
