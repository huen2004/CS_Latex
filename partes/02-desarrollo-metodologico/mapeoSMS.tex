...
\begin{table}[H]
	...
	\begin{tabular}{|p{0.7cm}|p{1.3cm}|p{5.5cm}|p{6cm}|} % Total: 14cm
		...
		Sobre las arquitecturas de seguridad en entornos de computación en la nube, alineadas con los controles de las normas \ISO/IEC 27001, 27017 y demás estándares internacionales y su impacto en contextos institucionales y universitarios: \newline
...
En esta etapa del proceso fue necesario establecer un marco que permitiera identificar las palabras clave más apropiadas para el mapeo 
...
seleccionadas, con el objetivo de mantener uniformidad en el proceso de búsqueda. Esta estrategia permitió asegurar consistencia en la recuperación de estudios primarios y facilitar 
...
revisión se generaron métricas de calidad para cada artículo, con el objetivo de priorizar aquellos más relevantes para la investigación. 
...
directa se obtuvieron 7 estudios nuevos, mientras que la búsqueda por bola de nieve inversa se obtuvieron 8 estudios nuevos, lo que 
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Cantidad de artículos por año y métricas de calidad definidas en~\ref{sec:priorizacionEstudios}}\label{fig:plot-anios-vs-indices-calidad}
\end{figure}

%------------------------------------------------------------------------------------------------------------------------
\subsection{Diferencias entre estrategias}

En la figura~\ref{fig:plot-estrategia_vs_articulos} se puede apreciar la cantidad de artículos obtenido por cada estrategia.

\begin{figure}[H]
	\centering
	\includegraphics[scale=0.4] {tablas-images/sms/procedencia_datos.png}
	\caption{Diagrama de la procedencia de los datos}\label{fig:plot-estrategia_vs_articulos}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagrama del promedio de índices de calidad por año}\label{fig:plot-indices}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Diagrama de los términos de búsqueda}\label{fig:terminos}
\end{figure}
