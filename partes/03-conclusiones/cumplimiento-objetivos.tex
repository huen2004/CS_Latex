...
El objetivo fue cumplido mediante la implementación de un prototipo funcional basado en la arquitectura de seguridad 
propuesta para la infraestructura de computación en la nube del \GRID. Para ello, se desplegó un entorno de pruebas que 
replicó los componentes esenciales de la arquitectura, integrando tecnologías de seguridad orientadas a la protección 
perimetral, detección y prevención de intrusiones, gestión centralizada de eventos y monitoreo de la infraestructura.

La implementación permitió materializar los elementos arquitectónicos definidos durante las fases de diseño, validando la 
interoperabilidad entre los componentes seleccionados y la viabilidad técnica de la propuesta. Asimismo, se configuraron 
mecanismos de segmentación, supervisión y generación de alertas que permitieron establecer una base funcional para el 
fortalecimiento de la seguridad de la infraestructura.

El prototipo desarrollado constituye una representación operativa de la arquitectura propuesta, evidenciando que los 
controles, tecnologías y procesos definidos pueden ser implementados de manera coordinada para apoyar la protección de los 
activos de información y la gestión de eventos de seguridad dentro del entorno del \GRID.
...
El objetivo se cumplió mediante la ejecución de diferentes escenarios de validación sobre el entorno prototipo implementado. 
Estas pruebas permitieron evaluar el comportamiento de los componentes de la arquitectura ante eventos y actividades 
potencialmente maliciosas, verificando la capacidad de detección, registro y supervisión proporcionada por las tecnologías 
seleccionadas.

Los resultados obtenidos evidenciaron la correcta integración entre los mecanismos de protección perimetral, detección de 
intrusiones y gestión de eventos de seguridad, permitiendo validar la funcionalidad de la arquitectura propuesta. De igual 
forma, las pruebas demostraron la capacidad del entorno para generar evidencias, centralizar información relevante y 
proporcionar una visión integral de los eventos de seguridad ocurridos dentro de la infraestructura.

En consecuencia, la validación realizada confirmó la viabilidad técnica de la arquitectura de seguridad propuesta y su 
contribución al fortalecimiento de la protección, supervisión y gestión de la seguridad en la infraestructura de 
computación en la nube del \GRID.

\textbf{Actividades realizadas}:
\begin{itemize}
	\item Ejecución de escenarios de prueba orientados a evaluar la capacidad de detección, monitoreo y respuesta de la arquitectura propuesta.
	\item Simulación de ataques y actividades potencialmente maliciosas sobre los componentes expuestos dentro del entorno prototipo.
	\item Verificación del flujo de eventos entre los mecanismos de protección perimetral, detección de intrusiones y gestión de eventos de seguridad.
	\item Evaluación de la capacidad de las tecnologías implementadas para generar alertas, registrar evidencias y proporcionar visibilidad sobre los eventos de seguridad.
	\item Análisis del comportamiento integrado de los componentes de la arquitectura ante diferentes escenarios de seguridad.
\end{itemize}

\textbf{Resultados obtenidos}:
\begin{itemize}
	\item Validación de la interoperabilidad entre OPNsense, Suricata y Wazuh dentro del entorno prototipo.
	\item Detección satisfactoria de eventos de seguridad generados durante los escenarios de prueba ejecutados.
	\item Generación y centralización de registros de seguridad que permitieron evidenciar la trazabilidad de los eventos analizados.
	\item Corroboración de la capacidad de la arquitectura para proporcionar visibilidad sobre actividades potencialmente sospechosas dentro de la infraestructura.
	\item Confirmación de la viabilidad técnica de la arquitectura propuesta para fortalecer la supervisión y protección de la infraestructura de computación en la nube del \GRID.
\end{itemize}
