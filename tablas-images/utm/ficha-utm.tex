\begin{table}[H]
	...
	\begin{tabular}{|p{0.25\textwidth}|p{0.6\textwidth}|p{0.12\textwidth}|}
		...
		\multirow{3}{*}{\includegraphics[width=\linewidth,keepaspectratio]{tablas-images/utm/utm.png}} \\ \cline{1-2}
		...
		\textbf{Núcleos de procesamiento de seguridad} & 24  & \\ \hline
		\textbf{Memoria} & 4 GB de memoria RAM & \\ \hline
